...
ggsave("results/final_figures/3d_GO_upregulated_logFC1.pdf", plot = p1, width = 8, height = 6)

# Plot 2 - Downregulated
p2 <- dotplot(ego_result_dn_strong, showCategory=10) +
  ggtitle("GO Analysis - Downregulated Genes")

ggsave("results/final_figures/3d_GO_downregulated_logFC1.pdf", plot = p2, width = 8, height = 6)
