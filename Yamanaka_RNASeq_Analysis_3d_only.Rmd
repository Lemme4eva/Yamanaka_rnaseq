...
This is the script in which I analyze the timepoint of 3d after injury only, in a distinct DESeq2 analysis. Most of the script will look the same as the Yamanaka_RNASeq_Analasys.Rmd file, I am just changing bits of the code, but will leave also the assigned names of the different analysis etc. the same. 
...
# subset metadata and drop time-level 
...
colData(vsd_blind_3d)$genotype_time <- factor(
  paste(colData(vsd_blind_3d)$genotype, colData(vsd_blind_3d)$time, sep="_")
)
